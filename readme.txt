=== RSS feed for Woo ===
Contributors: laserology, vladjpuscasu
...
== Changelog ==
= 1.4.2 =
* Updated for WordPress 7.1 compatibility.

= 1.4.1 =
* Implement reporting of sales prices and dates.
* Add safety checks.
* Add documentation.
* Refactor code.

= 1.4 =
* Refactor major parts of the codebase to be more efficient
* Improve RSS output for variable products
* Cleaner code

= 1.3.12 =
* Updated for WordPress 7.0 compatibility.
* Raised minimum requirements: WordPress 7.0, PHP 7.4.
